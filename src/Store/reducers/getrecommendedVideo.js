...
export const GetRecommendedVideos = createAsyncThunk(
    ...
    async(videoId,{getState})=>  
    {
        ...
        const response =await axios.get(`https://youtube.googleapis.com/youtube/v3/activites?&key=${API_KEY}&channelId=${channelId}{&part=snippet,contentDetails&maxResults=20&type=videoId=${videoId}`);
